<table  style="border: 1px solid black;">
	<tr>
		<th colspan="5" style="text-align: center; font-size: 16px;">LAPORAN REKAP DATA TABUNGAN KELUAR</th>
	</tr>
	<tr>
      ...
      <th	style="width:23px; text-align: center; border: 1px solid black;">Tanggal Keluar</th>
		<th   style="width:23px; text-align: center; border: 1px solid black;">Jumlah Uang Keluar</th>
	...
	<tr>
         ...
         <td style="text-align: center; border: 1px solid black;">{{date('d-m-Y ',strtotime($item->tanggal_keluar))}}</td>
			<td style="text-align: center; border: 1px solid black;">{{number_format($item->jumlah_uang_keluar)}}</td>
